...
<p class=" w-full  p-4 md:w-full mt-14 text-base font-bold tracking-wide break-words text-left">
    ...
    to our community. Our unscripted conversations cover a wide range of topics,
     ...
     dose of insightful commentary, thoughtful discussion, and good vibes.
   </p>
   <p class=" w-full p-4 md:w-full  text-base font-bold tracking-wide text-left break-words">
