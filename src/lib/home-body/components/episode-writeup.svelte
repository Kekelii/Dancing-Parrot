...
<div in:fade="{{duration:2000,delay:600}}" class=" text-white subpixel-antialiased scrollbar-hidden font-medium w-5/5  h-52 ml-5 mr-5 text-xs  md:text-sm  tracking-wider leading-relaxed text-left  mt-2 overflow-y-auto md:w-5/5   md:h-32 ">
    {#if !reveal}
